...
const content = {
    ...
    1:  <div>
            <h1>Sounds and Images</h1>
            <p className="small">
            LWL-Industriemuseum: CC BY 4.0 [Person, die Aufnahmen gemacht hat (Sound, Foto, Video)]<br />
            Museum für Druckkunst Leipzig: CC BY-SA 3.0 DE<br />
            Leander Seige: CC0<br />
            All details:<br />
            </p>
            <h1>Software</h1><br />
